        ...
        >
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
              ...
              <div className="glass-card p-6 rounded-xl border border-white/10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:caffeine.rohit@gmail.com" className="text-gray-400 hover:text-primary transition-colors">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <form onSubmit={handleSubmit} className="glass-card p-6 md:p-8 rounded-xl space-y-6 border border-white/10">
                <div>
                  <Input
                    type="text"
                    name="name"
                ...
                <div>
                  <Textarea
                    ...
                    required
                    rows={5}
                    className="bg-black/50 resize-none border-white/10"
                  />
                </div>
                <Button
                  type="submit"
