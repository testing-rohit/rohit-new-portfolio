  ...
  return (
    ...
    >
      ...
      >
        {/* Front */}
        <div
          className="absolute w-full h-full glass-card rounded-2xl overflow-hidden backface-hidden"
        ...
        {/* Back */}
        <div
          className="absolute w-full h-full glass-card rounded-2xl p-6 backface-hidden flex flex-col justify-between"
          style={{
        ...
        >
          <div>
            ...
            <p className="text-sm text-foreground/90 mb-6">{description}</p>
